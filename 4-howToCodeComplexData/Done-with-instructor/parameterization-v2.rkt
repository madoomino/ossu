...
(check-expect (contains? "Cairo" (cons "UBC" (cons "McGill" empty))) false)
...
;; maps the given list to a new one based on the given function
...
;; filters a given list based on a given function
